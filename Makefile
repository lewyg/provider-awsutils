...
PROJECT_NAME ?= provider-awsutils
...
xpkg.build.provider-awsutils: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/awsutilss/01-delete.yaml.tmpl.
